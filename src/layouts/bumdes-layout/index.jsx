...
import { FooterComp, NavBar, BumdesSidebar } from "../../components";
import { routes } from "../../routes/bumdes-route";
...
const BUMDesLayout = () => {
  ...
  const getRedirect = () => {
    if (localStorage.getItem("jwt") && role === "bumdes") {
  ...
  return (
    <div className="layout" style={{ height: "100%", maxHeight: "100vh" }}>
      <BumdesSidebar toggle={toggleSidebar} isOpen={sidebarIsOpen} />
