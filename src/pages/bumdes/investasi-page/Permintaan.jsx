...
const PERMINTAAN_INVESTASI_HEADER = [
  "ID",
  "NAMA MITRA",
  "TARGET",
  "DANA TERKUMPUL",
...
const PERMINTAAN_INVESTASI_DATA = [
  {
    ID: 1232,
    "NAMA MITRA": "Rara Sekar",
    TARGET: "Rp10.000.000",
    "DANA TERKUMPUL": "Rp5.500.000",
...
const PermintaanInvestasiBumdes = () => {
  const [tableData, setTableData] = useState(PERMINTAAN_INVESTASI_DATA);
  ...
  return (
    <Container>
      <SubTitle title="Permintaan" addButton={true} addFunction={() => console.log("add fired")} />
      <Card className="mt-4 border-0 shadow-sm">
        <CardBody className="p-0">
          ...
          <CustomTable bordered={false} headers={PERMINTAAN_INVESTASI_HEADER} tableData={tableData} sortBy={sortBy} />
        </CardBody>
...
export default PermintaanInvestasiBumdes;
