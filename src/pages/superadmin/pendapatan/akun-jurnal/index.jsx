...
const AkunJurnal = (props) => {
    ...
    const goToAddPpobPage = () => {
        props.history.push("/super-admin/akun-jurnal/add");
    }
    return (
        <div className="akun-jurnal">
                                    ...
                                    response
                                        ...
                                        .map((data, i) => {
                                            return (
                                                <tr key={data.id}>
                                                    <td className="">{i + 1}</td>
                                                    <td className="">{data?.kode_akun}</td>
                                                    <td className="">{data?.nama_akun}</td>
                                                    <td className="">{data?.deskripsi}</td>
                                                    <td className="">{data?.jenis_transaksi}</td>
                                                    <td className="">{data?.metode_bayar}</td>
                                                    ...
                                                    <td className="d-flex">
                                                        <RouterLink
                                                            ...
                                                            title="Edit"
                                                            to={{
                                                                pathname: `/super-admin/akun-jurnal/edit/${data.id}`,
                                                                state: {
                                                                    data: data,
                                                                },
                                                            }}
