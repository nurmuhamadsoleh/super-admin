...
const data = [
    {
        id: 1,
        kategori: "MOBILE CREDIT",
        nama_produk: "ISATIO",
        deskripsi: " INDOSAT 10.000",
        harga_asli: 10000,
        fee: 1000,
    },
    {
...
const PpobPage = (props) => {
    ...
    const goToAddPpobPage = () => {
        props.history.push("/super-admin/ppob/add");
    };
    return (
        <div className="ppob-page">
            <div className="card bg-white shadow-lg">
                <div className="card-body">
                    <div className="d-flex justify-content-between ">
                        <h6 className="mt-2">PPOB</h6>
                                        ...
                                        .map((data, i) => {
                                            return (
                                                <tr key={data.id}>
                                                    ...
                                                    <td className="">{data?.nama_produk}</td>
                                                    <td className="">{data?.deskripsi}</td>
                                                    <td className="">{data?.harga_asli}</td>
                                                    ...
                                                    <td className="d-flex">
                                                        <RouterLink
                                                            ...
                                                            title="Edit"
                                                            to={{
                                                                pathname: `/super-admin/ppob/edit/${data.id}`,
                                                                state: {
                                                                    data: data,
                                                                },
                                                            }}
