...
const SuratKeteranganDudaJandaPage = () => {
  ...
  return (
    <div className="surat-keterangan-duda-janda-page">
      <div className="header">
        <div className="card shadow">
          <div className="container-fluid">
            <div className="d-flex justify-content-start mt-4 mb-4">
              <b>Surat Keterangan Beda Identitas</b>
            </div>
          </div>
        </div>
      </div>
...
export default SuratKeteranganDudaJandaPage;
