...
const SuratRekomendasiIzinKeramaianPage= () => {
  ...
  return (
    <div className="surat-rekomendasi-izin-keramaian">
      <div className="header">
        <div className="card shadow">
          <div className="container-fluid">
            <div className="d-flex justify-content-start mt-4 mb-4">
              <b>Surat Rekomendasi Izin Keramaian</b>
            </div>
          </div>
        </div>
      </div>
...
export default SuratRekomendasiIzinKeramaianPage;
