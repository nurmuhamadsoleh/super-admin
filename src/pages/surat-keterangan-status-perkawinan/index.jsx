...
const SuratKeteranganStatusPerkawinan = () => {
  ...
  return (
    <div className="surat-keterangan-status-perkawinan">
      <div className="header">
        <div className="card shadow">
          <div className="container-fluid">
            <div className="d-flex justify-content-start mt-4 mb-4">
              <b>Surat Keterangan Status Perkawinan</b>
            </div>
          </div>
        </div>
      </div>
...
export default SuratKeteranganStatusPerkawinan;
