...
const SuratPengantarPerkawinanPriaPage= () => {
  ...
  return (
    <div className="surat-pengantar-perkawinan-pria">
      <div className="header">
        <div className="card shadow">
          <div className="container-fluid">
            <div className="d-flex justify-content-start mt-4 mb-4">
              <b>Surat Pengantar Perkawinan Pria</b>
            </div>
          </div>
        </div>
      </div>
...
export default SuratPengantarPerkawinanPriaPage;
