...
const SuratKeteranganAlpaPage = () => {
  ...
  return (
    <div className="surat-keterangan-alpa-page">
      <div className="header">
        <div className="card shadow">
          <div className="container-fluid">
            <div className="d-flex justify-content-start mt-4 mb-4">
              <b>Surat Keterangan Izin Tidak Masuk Kerja</b>
            </div>
          </div>
        </div>
      </div>
...
export default SuratKeteranganAlpaPage;
