...
const SuratKeteranganDomisiliPerusahaanPage = () => {
  ...
  return (
    <div className="surat-keterangan-domisili-perusahaan-page">
      <div className="header">
        <div className="card shadow">
          <div className="container-fluid">
            <div className="d-flex justify-content-start mt-4 mb-4">
              <b>Surat Keterangan Domisili Perusahaan</b>
            </div>
          </div>
        </div>
      </div>
...
export default SuratKeteranganDomisiliPerusahaanPage;
