...
import EditPendukungDesa from "./edit-pendukung-desa";

const dummyData = [
    {
        id: 1,
        name: "Kepolisian",
        alamat: "Jl. Ancol Timur XIV No.1",
        kontak: "081521457589",
    },
    {
        id: 2,
...
const PendukungDesa = () => {
    ...
    return (
        <div className="pendukung-desa">
            <div className="header">
                <div className="card shadow bg-white">
                    <div className="container-fluid">
                        <div className="d-flex justify-content-start mt-3 mb-3">
                            <h5>Pendukung Desa</h5>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        .map((data, i) => {
                                            ...
                                            return (
                                                <tr key={data.id}>
                                                    ...
                                                    <td className="">{data?.alamat}</td>
                                                    <td className="">{data?.kontak}</td>
