...
import TableSelesai from "../../surat-keterangan-kelahiran-page/table-selesai";
import { SubTitle } from "../../../components";
import { useHistory, useRouteMatch } from "react-router";

const PengajuanEdesaPage = () => {
  ...
  return (
    <div className="surat-pengantar-polisi">
      <SubTitle
        title="Pengajuan E-Desa"
        addButton={true}
        addFunction={onClickAdd}
        buttonLabel="Buat Surat"
      />
...
export default PengajuanEdesaPage;
