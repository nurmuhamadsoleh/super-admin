...
const SuratKeteranganResiKtpPage = () => {
  ...
  return (
    <div className="surat-keterangan-resi-ktp">
      <div className="header">
        <div className="card shadow">
          <div className="container-fluid">
            <div className="d-flex justify-content-start mt-4 mb-4">
              <b>Surat Keterangan Resi KTP Sementara</b>
            </div>
          </div>
        </div>
      </div>
...
export default SuratKeteranganResiKtpPage;
