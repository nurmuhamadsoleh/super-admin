...
const SuratKeteranganUsahaNonWargaPage = () => {
  ...
  return (
    <div className="surat-keterangan-usaha-non-warga">
      <div className="header">
        <div className="card shadow">
          <div className="container-fluid">
            <div className="d-flex justify-content-start mt-4 mb-4">
              <b>Surat Keterangan Usaha (Non Warga)</b>
            </div>
          </div>
        </div>
      </div>
...
export default SuratKeteranganUsahaNonWargaPage;
